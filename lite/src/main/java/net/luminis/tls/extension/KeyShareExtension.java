...
public class KeyShareExtension extends Extension {
    ...
    public static final Map<TlsConstants.NamedGroup, Integer> CURVE_KEY_LENGTHS = new HashMap<TlsConstants.NamedGroup, Integer>() {{
        put(secp256r1, 65);
        put(x25519, 32);
        put(x448, 56);
    }};
    ...
    public static final List<TlsConstants.NamedGroup> supportedCurves =
            Arrays.asList(secp256r1, x25519, x448);

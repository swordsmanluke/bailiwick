...
//
//class RefreshRunner(val context: Context, val peers: List<PeerId>, val keys: Keyring, val ipfs: IpfsStore, val ipns: IpnsCacheDao) {
//    companion object {
...
//        val manifest = Manifest(cipher, ipfs, manifestCid)
